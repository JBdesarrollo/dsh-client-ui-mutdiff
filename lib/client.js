		...
		function primeBridge() {
			...
			fetch(`${BRIDGE_PREFIX}/state`, { headers: { accept: "application/json" } }).then((response) => {
				...
				publishBridge({
					...
					editors,
					editor: chosen,
					autoOpen: autoOpenChoice === void 0 ? body.autoOpen === true : autoOpenChoice === "1"
				});
			}).catch((error) => {
				publishBridge({ status: "unavailable" });
											...
											children: [
												...
												menuOpen && react_jsx_runtime.jsxs("div", {
													...
													children: [
														...
														react_jsx_runtime.jsx("span", { key: "note", className: css_styles.editorMenuNote, children: tt(t, "mutdiff.autoOpenNote", "Opening raises the editor window") })
													]
												})
											]
										}),
