...
/**
 * Read the plugin's config defensively.
 *
 * Reachable from a profile's patch layer as an id-targeted override
...
export function normalizeConfig(raw) {
  ...
  return {
    ...
    editor: typeof source.editor === 'string' && source.editor.trim() !== '' ? source.editor.trim() : 'auto',
    ...
    gotoLine: source.gotoLine !== false,
